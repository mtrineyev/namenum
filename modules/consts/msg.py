...
command_interesting = '*Цікавинки про натуральні числа:*\n\n'\
    ...
    'неповторюваних шахових партій — новемтрігінтильйон (10**120), '\
    'це більше, ніж атомів у спостережуваному Всесвіті, '\
    'що за середніми оцінками складає сто квінвігінтильйонів (10**80)!\n\n'\
    ' 📍 Тіло 70 кг людини в середньому складається з '\
    'шестисот октильйонів семисот септильйонів (6,7×10**27) атомів\n\n'\
